(function () {
  ...
  var termDict = {
    ...
    '求嗣': { cat: '宜', meaning: '祈求子嗣、生育', usage: '适合求子、备孕、祈福后代。' },
    '开光': { cat: '宜', meaning: '神像、佛像、吉祥物开光', usage: '适合宗教开光仪式、新店开业点睛。' },
    '塑绘': { cat: '宜', meaning: '雕塑、绘画神像', usage: '适合制作宗教造像、壁画。' },
    '齐醮': { cat: '宜', meaning: '道教设坛祭祷', usage: '适合道教斋醮仪式。' },
    '斋醮': { cat: '宜', meaning: '道教设坛祭祷', usage: '适合道教法事、祈福消灾。' },
    '酬神': { cat: '宜', meaning: '答谢神明', usage: '适合还愿、谢神、答谢庇护。' },
    '造庙': { cat: '宜', meaning: '建造庙宇', usage: '适合修建寺庙、道观。' },
    '祀灶': { cat: '宜', meaning: '祭拜灶神', usage: '适合祭灶、谢灶。' },
    '焚香': { cat: '宜', meaning: '烧香祭拜', usage: '适合上香、敬神、礼佛。' },
    '谢土': { cat: '宜', meaning: '答谢土地神', usage: '适合工程完工后谢土、安宅。' },
    '出火': { cat: '宜', meaning: '移动神位、香火', usage: '适合分炉、移神位、迁香火。' },
    '雕刻': { cat: '宜', meaning: '雕刻神像、器物', usage: '适合雕刻宗教造像、工艺品。' },
    '订婚': { cat: '宜', meaning: '订立婚约', usage: '适合举办订婚仪式、交换信物。' },
    '纳采': { cat: '宜', meaning: '男方向女方提亲', usage: '适合提亲、送聘礼。' },
    '问名': { cat: '宜', meaning: '询问女方姓名八字', usage: '适合合婚、问名。' },
    '纳婿': { cat: '宜', meaning: '招女婿入门', usage: '适合入赘、招婿。' },
    '归宁': { cat: '宜', meaning: '新娘回娘家', usage: '适合婚后回门、归宁。' },
    '合帐': { cat: '宜', meaning: '缝制婚帐', usage: '适合制作婚被、婚帐。' },
    '冠笄': { cat: '宜', meaning: '成人礼', usage: '适合举办成年礼、冠礼、笄礼。' },
    '订盟': { cat: '宜', meaning: '缔结盟约', usage: '适合结拜、订盟、立约。' },
    '进人口': { cat: '宜', meaning: '收纳人口、雇佣', usage: '适合收养、纳婢、雇佣。' },
    '裁衣': { cat: '宜', meaning: '裁剪衣服', usage: '适合做新衣、裁制嫁衣。' },
    '挽面': { cat: '宜', meaning: '传统美容开脸', usage: '适合新娘开脸、美容。' },
    '开容': { cat: '宜', meaning: '化妆、开脸', usage: '适合新娘化妆、开容。' },
    '修坟': { cat: '宜', meaning: '修缮坟墓', usage: '适合修墓、立碑、扫墓。' },
    '启钻': { cat: '宜', meaning: '打开墓穴', usage: '适合迁葬、启攒。' },
    '破土': { cat: '宜', meaning: '挖土动工（多用于墓葬）', usage: '适合墓葬破土、工程破土。' },
    '安葬': { cat: '宜', meaning: '下葬', usage: '适合举行安葬仪式。' },
    '立碑': { cat: '宜', meaning: '竖立墓碑', usage: '适合立碑、刻字。' },
    '成服': { cat: '宜', meaning: '穿上丧服', usage: '适合丧礼成服。' },
    '除服': { cat: '宜', meaning: '脱去丧服', usage: '适合丧期结束、除服。' },
    '开生坟': { cat: '宜', meaning: '生前预造坟墓', usage: '适合生前修寿坟。' },
    '合寿木': { cat: '宜', meaning: '制作寿棺', usage: '适合制作棺木、寿材。' },
    '入殓': { cat: '宜', meaning: '将遗体入棺', usage: '适合入殓仪式。' },
    '移柩': { cat: '宜', meaning: '移动棺柩', usage: '适合迁柩、移棺。' },
    '普渡': { cat: '宜', meaning: '超度亡灵', usage: '适合超度、普渡法会。' },
    '安香': { cat: '宜', meaning: '安置香炉、神位', usage: '适合安神位、安香火。' },
    '安门': { cat: '宜', meaning: '安装门户', usage: '适合安装大门、房门。' },
    '起基': { cat: '宜', meaning: '奠定基础', usage: '适合动土起基、奠基。' },
    '上梁': { cat: '宜', meaning: '安装屋梁', usage: '适合上梁、架梁。' },
    '竖柱': { cat: '宜', meaning: '竖立柱子', usage: '适合竖柱、立框架。' },
    '开井开池': { cat: '宜', meaning: '开凿水井、水池', usage: '适合挖井、开池。' },
    '作陂放水': { cat: '宜', meaning: '修筑水陂、放水', usage: '适合修水利、放水。' },
    '拆卸': { cat: '宜', meaning: '拆除建筑物', usage: '适合拆房、拆卸。' },
    '破屋': { cat: '宜', meaning: '拆除旧屋', usage: '适合拆旧屋、破屋。' },
    '坏垣': { cat: '宜', meaning: '拆除围墙', usage: '适合拆墙、坏垣。' },
    '补垣': { cat: '宜', meaning: '修补围墙', usage: '适合补墙、修垣。' },
    '伐木做梁': { cat: '宜', meaning: '砍伐木材做梁', usage: '适合伐木、做梁。' },
    '作灶': { cat: '宜', meaning: '修造炉灶', usage: '适合厨房改造、炉灶安装。' },
    '开柱眼': { cat: '宜', meaning: '在柱上开孔', usage: '适合木工开柱眼。' },
    '穿屏扇架': { cat: '宜', meaning: '安装屏风、扇架', usage: '适合安装屏风、隔断。' },
    '盖屋合脊': { cat: '宜', meaning: '盖屋顶、合脊', usage: '适合盖屋、合脊。' },
    '开厕': { cat: '宜', meaning: '建造厕所', usage: '适合建厕所、开厕。' },
    '造仓': { cat: '宜', meaning: '建造仓库', usage: '适合建仓库、粮仓。' },
    '塞穴': { cat: '宜', meaning: '堵塞洞穴', usage: '适合填塞洞穴、蚁穴。' },
    '平治道涂': { cat: '宜', meaning: '修整道路', usage: '适合修路、铺路。' },
    '造桥': { cat: '宜', meaning: '建造桥梁', usage: '适合建桥、修桥。' },
    '作厕': { cat: '宜', meaning: '建造厕所', usage: '适合建厕所。' },
    '筑堤': { cat: '宜', meaning: '修筑堤坝', usage: '适合筑堤、防洪。' },
    '开池': { cat: '宜', meaning: '开凿水池', usage: '适合挖池、开塘。' },
    '伐木': { cat: '宜', meaning: '砍伐树木', usage: '适合伐木、砍树。' },
    '开渠': { cat: '宜', meaning: '开凿水渠', usage: '适合开渠、引水。' },
    '掘井': { cat: '宜', meaning: '挖掘水井', usage: '适合挖井、掘井。' },
    '扫舍': { cat: '宜', meaning: '打扫房屋', usage: '适合大扫除、清扫。' },
    '放水': { cat: '宜', meaning: '排放水', usage: '适合放水、排水。' },
    '造屋': { cat: '宜', meaning: '建造房屋', usage: '适合建房、造屋。' },
    '合脊': { cat: '宜', meaning: '合拢屋脊', usage: '适合盖屋合脊。' },
    '造畜稠': { cat: '宜', meaning: '建造牲畜棚', usage: '适合建畜栏、禽舍。' },
    '修门': { cat: '宜', meaning: '修理门户', usage: '适合修门、换门。' },
    '定磉': { cat: '宜', meaning: '安放柱础', usage: '适合定柱础、安基石。' },
    '作梁': { cat: '宜', meaning: '制作屋梁', usage: '适合做梁、架梁。' },
    '修饰垣墙': { cat: '宜', meaning: '修整墙壁', usage: '适合刷墙、修墙。' },
    '架马': { cat: '宜', meaning: '搭设木马架', usage: '适合木工架马。' },
    '挂匾': { cat: '宜', meaning: '悬挂牌匾', usage: '适合挂牌、挂匾。' },
    '求财': { cat: '宜', meaning: '求取钱财', usage: '适合求财、开财路。' },
    '开仓': { cat: '宜', meaning: '打开仓库', usage: '适合开仓、出库。' },
    '置产': { cat: '宜', meaning: '购置产业', usage: '适合买房、置地、买资产。' },
    '雇佣': { cat: '宜', meaning: '雇佣人员', usage: '适合招工、雇人。' },
    '出货财': { cat: '宜', meaning: '发出货物、钱财', usage: '适合发货、出货。' },
    '安机械': { cat: '宜', meaning: '安装机器', usage: '适合安装设备、机械。' },
    '造车器': { cat: '宜', meaning: '制造车辆、器具', usage: '适合造车、制器。' },
    '经络': { cat: '宜', meaning: '织布、编织', usage: '适合纺织、编织。' },
    '酝酿': { cat: '宜', meaning: '酿酒、发酵', usage: '适合酿酒、做酱、发酵。' },
    '作染': { cat: '宜', meaning: '染色', usage: '适合染布、染色。' },
    '鼓铸': { cat: '宜', meaning: '冶炼、铸造', usage: '适合铸造、冶炼。' },
    '造船': { cat: '宜', meaning: '建造船只', usage: '适合造船、修船。' },
    '割蜜': { cat: '宜', meaning: '割取蜂蜜', usage: '适合采蜜、割蜜。' },
    '取渔': { cat: '宜', meaning: '捕鱼', usage: '适合捕鱼、打渔。' },
    '结网': { cat: '宜', meaning: '编织渔网', usage: '适合结网、织网。' },
    '牧养': { cat: '宜', meaning: '放牧、饲养', usage: '适合放牧、养殖。' },
    '安碓磑': { cat: '宜', meaning: '安装舂米设备', usage: '适合安装碓磨。' },
    '入学': { cat: '宜', meaning: '入学、拜师', usage: '适合入学、拜师、开学。' },
    '理发': { cat: '宜', meaning: '理发、剪发', usage: '适合理发、剪发。' },
    '探病': { cat: '宜', meaning: '探望病人', usage: '适合探病、慰问。' },
    '见贵': { cat: '宜', meaning: '拜见贵人', usage: '适合拜访贵人、求见。' },
    '乘船': { cat: '宜', meaning: '乘船出行', usage: '适合乘船、渡水。' },
    '渡水': { cat: '宜', meaning: '渡水过河', usage: '适合渡水、过河。' },
    '针灸': { cat: '宜', meaning: '针灸治疗', usage: '适合针灸、理疗。' },
    '分居': { cat: '宜', meaning: '分家、分居', usage: '适合分家、分开居住。' },
    '剃头': { cat: '宜', meaning: '剃头、理发', usage: '适合剃头、剪发。' },
    '整手足甲': { cat: '宜', meaning: '修剪手足指甲', usage: '适合剪指甲、修甲。' },
    '纳畜': { cat: '宜', meaning: '收养牲畜', usage: '适合买牲畜、收养宠物。' },
    '捕捉': { cat: '宜', meaning: '捕捉、抓拿', usage: '适合捕捉、抓拿。' },
    '畋猎': { cat: '宜', meaning: '打猎', usage: '适合打猎、狩猎。' },
    '教牛马': { cat: '宜', meaning: '训练牛马', usage: '适合驯养牛马。' },
    '赴任': { cat: '宜', meaning: '上任、赴职', usage: '适合上任、就职。' },
    '求医': { cat: '宜', meaning: '求医问诊', usage: '适合看病、就医。' },
    '治病': { cat: '宜', meaning: '治疗疾病', usage: '适合治疗、动手术。' },
    '词讼': { cat: '宜', meaning: '诉讼、打官司', usage: '适合诉讼、打官司。' },
    ...
    '求助': { cat: '宜', meaning: '寻求帮助、请教他人', usage: '适合向他人求助、请教、寻求支持。' },
    // ============ 现代工业大类词 ============
    '生产制造': { cat: '宜', meaning: '生产排产、产线运行、设备调试、工艺优化、质量检验', usage: '适合安排生产计划、产线调试、工艺优化、质量管控等制造环节。' },
    '项目建设': { cat: '宜', meaning: '新项目立项、厂房建设、设备安装、产线验收', usage: '适合项目立项、工程建设、设备安装调试、竣工验收。' },
    '供应链管理': { cat: '宜', meaning: '采购、仓储、物流、库存盘点、供应商对接', usage: '适合采购招标、物料齐套、仓储盘点、物流发运。' },
    '市场拓展': { cat: '宜', meaning: '市场调研、客户开发、渠道铺设、展会招商', usage: '适合市场调研、客户拜访、渠道拓展、展会筹备。' },
    '运营管理': { cat: '宜', meaning: '日常运营、流程优化、合规检查、安全环保', usage: '适合运营调度、流程优化、安全巡检、环保合规。' },
    '放空': { cat: '宜', meaning: '放空自己、休息放松', usage: '适合什么都不做、放空、给自己充电。' }
  };
  ...
  function loadHuangLi() {
    ...
    var rawYiArr = lunarObj.getDayYi() || [];
    var jiArr = lunarObj.getDayJi() || [];

    // 过滤：生活化建议只有在其传统母项也出现时才显示
    var yiArr = rawYiArr.filter(function (item) {
      var parent = termParentMap[item];
      if (!parent) return true;              // 传统母项本身或未收录词条，保留
      return rawYiArr.indexOf(parent) > -1;  // 延伸项：母项出现才保留
    });
    if (yiArr.length === 0) yiArr = ['诸事不宜'];
